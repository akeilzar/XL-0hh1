...
var TutorialMessages = {
  1: { msg: 'We\'re going to fill the grid.<br>Tap the tile to make it neon.', tiles: [ [0,0,1] ] },
  2: { msg: 'Excellent!<br>Tap twice to turn a tile blue.', tiles: [ [0,1,2] ] },
  3: { msg: 'Three neon tiles next to each other in a row isn\'t allowed.', tiles: [ [2,0,2] ] },
  4: { msg: 'Never have three blue tiles together in a row either.', tiles: [ [1,1,1] ] },
  5: { msg: 'Three neon or blue tiles below each other is invalid too!', tiles: [ [1,2,2], [2,2,1] ] },
  6: { msg: 'A full row must have as many neon tiles as it has blue ones.', tiles: [ [3,1,1] ], rows: [1] },
